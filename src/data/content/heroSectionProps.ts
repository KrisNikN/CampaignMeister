...
export const heroSectionProps: HeroProps = {
  ...
  subHeading:
    'Optimising campaigns is hard, especially if you lack trustworthy data. Unfortunately this is the case for more than 65% of the companies. <br /> <br /> Boost your performance by fixing your data across all channels, brands and agencies.',
  image: {
